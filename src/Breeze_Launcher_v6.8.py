...
class StartMenu(Gtk.Window):
    ...
    def setup_css(self):
        ...
        * {
        ...
        #changelog_button {
            background-color: rgb(22,58,78);
            background-image: none;
            border: 1px solid rgb(95,150,175);
            border-radius: 11px;
            padding: 6px 11px;
            min-height: 30px;
            font-size: 11px;
        ...
        #changelog_button:hover {
            background-color: rgb(36,91,116);
            border-color: rgb(105,160,185);
        }

        #changelog_button:focus,
        #changelog_button:active {
            background-color: rgb(24,66,88);
            border-color: rgb(90,145,170);
            box-shadow: none;
            outline: none;
        }
